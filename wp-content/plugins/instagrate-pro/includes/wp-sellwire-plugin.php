<?php
/*
Sellwire WordPress Plugin Updater Class
http://sellwire.net
v1.0

Example Usage:
require_once('wp-sellwire-plugin.php');
new SellwirePluginUpdater_3lM( 'http://app.sellwire.net/api/1/plugin', plugin_basename(__FILE__) );
*/

if ( ! class_exists( 'SellwirePluginUpdater_3lM' ) ) {
	class SellwirePluginUpdater_3lM {
