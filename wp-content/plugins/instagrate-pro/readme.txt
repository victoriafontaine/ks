...
Intagrate is a powerful WordPress plugin that allows you to automatically integrate Instagram images into your WordPress site.
...
4. Go to the Intagrate menu item under the 'Settings' menu and connect your Instagram accounts and set the rest of configuration you want.
...
* Bug Fix: Google Maps not showing without API key.
...
* New: Rebrand to comply with Instagram guidelines

= 1.7.4 =

* Bug Fix: ALl Hashtagged Media stream not loading subsequent images

= 1.7.3 =

* Bug Fix: Caption template tags not stripping tags

= 1.7.2 =

* New: Post excerpt support
...
* Bug Fix: PHP Notice:  Undefined property: Instagrate_Pro_Controller::$video_count
...
* Bug Fix: Missing argument 2 for Instagrate_Pro_Comments::comment_text()
* Bug Fix: Fatal error on WP installs before 4.2 due to $wpdb->get_col_charset()
...
* Fix - Emojis in Instagram comments causing comments not to appear

= 1.6.4 =

* Fix - Emojis in Instagram hashtags causing fails in database insertion

= 1.6.3 =

* Fix - Caption with emojis not fully cleaned causing fails in database insertion
...
* Fix - Multisite sub site custom table not created
* Fix - License key not passed to WP Updates API when displaying plugin update details

= 1.6 =

* New - Brand new image moderation system. Set an account to require images to be moderated via a new page
* New - Escaped caption template tags for use in HTML attributes like title and alt
* New - Template tag to remove username mentions from caption
* New - Translation ready with .pot file
* Fix - General bug fixes
* Improvement - Comment content username mentions links not stored in database, now using filter
* Improvement - Complete rewrite of plugin code for scalability and to coding standards
* Improvement - Bulk status UI now has buttons not dropdown

= 1.5.5 =

* Fix - Duplicates in post_name (slug)
* Fix - Duplicating account does not copy custom meta
* Fix - Issues with connecting some Instagram accounts with emojis in bio

= 1.5.4 =

* Fix - Post slug not being created

= 1.5.3 =

* Fix - Posts being published now trigger hooks correctly for use by social media posting plugins
* New - Template tag %%image-date%% format can be altered with the filter 'igp_date_format'
...
* New - Intagrate now supports videos from Instagram.
...
Please visit the [support area](https://intagrate.io/support/).
